module github.com/focalsolution/micro-go-plugins
...
require (
	...
	github.com/focalsolution/asim-go-awsxray v0.0.0-20161209120537-0d8a60b6e205
	github.com/focalsolution/asim-go-bson v0.0.0-20160318195205-84522947cabd
